...
<h1 class="text-center mt-3" style="font-weight: bolder; font-size:6vh; color:blue;">Superliga LiveScores</h1>
    <div class="row mt-5">
...
<div class="col-lg-12 col-md-12 col-sm-12 text-center mb-5">
    ...
    <!--home logo--> <img style="width: 50px;" src="{{ $match['teams']['home']['img'] }}" alt="">
              {{ $match['teams']['home']['name'] }} {{ $match['scores']['home_score'] }} - {{ $match['scores']['away_score'] }} {{ $match['teams']['away']['name'] }}
     <!--away logo--> <img style="width: 50px;" src="{{ $match['teams']['away']['img'] }}" alt="">
            </div>
